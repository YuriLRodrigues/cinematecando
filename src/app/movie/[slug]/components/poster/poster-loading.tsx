  ...
  return (
    <div className="mx-auto my-6 grid w-full grid-cols-1 gap-10 px-2 md:grid-cols-4 md:px-0 lg:pl-16">
      ...
      <div className="md:col-span-3">
        <div className="space-y-8 md:min-h-80">
          <div className="mr-2 h-4 max-w-64 animate-pulse bg-slate-300 dark:bg-slate-600" />
          <div className="mr-4 h-12 max-w-full animate-pulse bg-slate-300 dark:bg-slate-600" />
        </div>
